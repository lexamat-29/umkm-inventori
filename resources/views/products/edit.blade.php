                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('products.update', $product) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="harga_beli" id="harga_beli" value="{{ old('harga_beli', $product->harga_beli) }}" required min="0" step="0.01"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-500">Rp</span>
                                    <input type="number" name="harga_jual" id="harga_jual" value="{{ old('harga_jual', $product->harga_jual) }}" required min="0" step="0.01"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <!-- Stock Quantity -->
                            <div>
                                <label for="stock_quantity" class="block text-sm font-medium text-gray-700 mb-2">Stok Saat Ini *</label>
                            ...
                            <div>
                                ...
                                <input type="number" name="minimum_stock_threshold" id="minimum_stock_threshold" value="{{ old('minimum_stock_threshold', $product->minimum_stock_threshold) }}" required min="0"
                        ...
                        <div class="flex gap-4">
                            ...
                            <button type="button" onclick="if(confirm('Yakin ingin menghapus produk ini?')) document.getElementById('delete-form').submit();" 
                                    class="ml-auto bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-6 rounded">
                                Hapus
                            </button>
                        </div>
                    </form>
